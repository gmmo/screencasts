...
void LightRenderer::Update(CameraData* pCamera)
{
    ObjectRenderer::Update(pCamera);
}

////////////////////////////////////////////////////////////////////////////////
void LightRenderer::UpdateLightCBuff()
{
...
////////////////////////////////////////////////////////////////////////////////
void LightRenderer::UpdateMaterialCBuff()
{
    auto context = m_deviceResources->GetD3DDeviceContext();
...
////////////////////////////////////////////////////////////////////////////////
void LightRenderer::Create()
{
    // Load shaders asynchronously.
    auto fileData = m_fileUtil.ReadFileSync(L"LightVS.cso");
    ...
    fileData = m_fileUtil.ReadFileSync(L"LightPS.cso");
